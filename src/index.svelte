...
<body>
      <div class="relative bg-white shadow-lg sm:rounded-3xl">
        ...
        <div class="flex items-center justify-start pt-8 pl-6">
        ...
        <div class="px-20 py-6">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-center">
              <div class="flex items-center justify-center text-3xl font-bold text-true-gray-800 ml-16">
          ...
          <div class="lg:2/6 xl:w-2/4 mt-20 lg:mt-40 lg:ml-16 text-left">
              <div class="text-4xl font-semibold text-gray-900 leading-none">Explore, Expand, <br /> Exploit, Exterminate</div>
          ...
          <div class="mt-12 lg:mt-32 lg:ml-20 text-left">
            <bottom class="flex items-center justify-center w-12 h-12 rounded-full bg-cool-gray-100 text-gray-800 animate-bounce hover:text-gray-900 hover:bg-cool-gray-50 transition duration-300 ease-in-out cursor-pointer">
